...
- Якщо вже можна шукати — не вважай це unknown.
 Якщо користувач вказує сімейства/дескриптори (наприклад: "свіжий фруктовий", "цитрусовий", "зелений", "морський"),
  обов'язково додай релевантні ноти/акорди у notes_top/notes_heart/notes_base/accords та search_terms.
- Не пиши загальні фрази замість суті: краще поверни короткий список конкретних нот/акордів.
- user_friendly_reply:
